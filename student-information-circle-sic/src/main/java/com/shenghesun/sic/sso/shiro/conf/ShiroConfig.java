package com.shenghesun.sic.sso.shiro.conf;
...
import com.shenghesun.sic.sso.redis.realization.CustomRedisCacheManager;
import com.shenghesun.sic.sso.redis.realization.CustomRedisSessionDAO;
import com.shenghesun.sic.sso.shiro.realization.CustomSessionManager;
import com.shenghesun.sic.sso.shiro.realization.CustomShiroRealm;
import com.shenghesun.sic.sso.shiro.realization.CustomSimpleCredentialsMatcher;
...
//	public static final String HASH_ALGORITHM_NAME = "md5";// 散列算法:这里使用MD5算法;
	...
	public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
		...
		filterChainDefinitionMap.put("/landing_page/**", "anon");
		...
		filterChainDefinitionMap.put("/check_token", "anon");
		filterChainDefinitionMap.put("/m/**", "anon");// m 开头的路径，通过 token filter 校验，所以这里选择 anon
		filterChainDefinitionMap.put("/stream/**", "anon");// stream 开头的路径，表示获取流信息，暂时不需要校验 token		
